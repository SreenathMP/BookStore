    ...
    render() {
        ...
        return (
            ...
            <ul className="pagination">
                ...
                <li className={pager.currentPage === 1 ? 'disabled' : ''}>
                    <a className="page-link" style={pagelink}onClick={() => this.setPage(pager.currentPage - 1)}>Previous</a>
                </li>
                ...
                <li className={pager.currentPage === pager.totalPages ? 'disabled' : ''}>
                    <a className="page-link" style={pagelink} onClick={() => this.setPage(pager.currentPage + 1)}>Next</a>
                </li>
                <li className={pager.currentPage === pager.totalPages ? 'disabled' : ''}>
